...
<!--
example:
    We hope to add event interface to code-policeman framework to access middleware such as Kafka and rabbitmq
-->

### Requirements description of the feature
<!--
example:
    The event interface should be added to code-policeman. The interface should contain subscribers and publishers, and the message body should contain key value head
-->
### References
<!--
example:
